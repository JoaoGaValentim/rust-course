...
fn main() {
    ...
    println!("===========");
    generate_multiplication_table(0, 10, 2);
    println!("===========");
    generate_multiplication_table(0, 10, 4);
    println!("===========");
    generate_multiplication_table(0, 10, 1000);
    println!("===========");
    generate_multiplication_table(0, 10, 1_000_000);
    println!("===========");
}
